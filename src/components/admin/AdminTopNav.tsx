      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex-1 max-w-md">
          <div className="relative">
            ...
            <input
              type="text"
              placeholder="Search users, products, or tasks..."
        ...
        <div className="flex items-center gap-4">
          {/* System Status */}
          <div className="flex items-center gap-2 px-3 py-2 bg-green-100 text-green-600 rounded-lg">
          ...
          <div className="relative">
            ...
            >
              ...
              <div className="text-left">
                <div className="text-sm font-medium text-[#333333]">Admin User</div>
